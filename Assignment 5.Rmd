...
female_phd_prop <- prop.table(as.matrix(female_phd_contingency))

female_phd_prop

female_phd_table <- female_phd_prop %>% 
  kable(caption = "Female PhD Contingency Matrix", col.names = c("Education", "Engineering", "Humanities & Arts", "Physical & Earth Sciences")) %>%
