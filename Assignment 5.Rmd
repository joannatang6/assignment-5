...
female_phd_prop <- prop.table(as.matrix(female_phd_contingency), 2)

female_phd_prop

female_phd_table <- female_phd_prop %>% 
  kable(caption = "Female PhD Contingency Matrix") %>%
...
# Faculty Salary = 68224 + 4492 * SexMale + 13723 * RankAssocProf + 47403 * RankProf + 13709 * Discipline B
