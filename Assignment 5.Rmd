...
The median starting non-postdoc employment positions differ significantly for males (median =  75167) and females (median = 71750)  in our samples (V = 101, *p* = 0.0026, $\alpha$ = .05, Cliff’s delta = .04).  Thus, median salary does not differ significantly between male and female starting non-postdoc employment position salaries.

Although the median starting postdoc positions for males (median =  48000) was higher than that for females (median = 45000) in our samples, there is no significant difference (V = 19.5, *p* = 0.89, $\alpha$ = .05, Cliff’s delta = 21).  Thus, median salary does not differ significantly between male and female starting postdoc position salaries.
