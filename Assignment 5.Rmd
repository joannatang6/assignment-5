...
However, we decided to eliminate both years in current position and years since doctoral degree was earned because both are correlated with rank.  This model, including only predictors of sex, rank, and discipline, best predicts faculty salary with the least complexity (and had the lowest AIC value).
