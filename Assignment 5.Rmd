...
chi_total #chi2 (48) = 2176400, p < .001, year affects proportion of males vs females

chi_full <- chisq.test(select(grad_enrollment_contingency, "Full_time_males", "Full_time_females"))
chi_full #chi2 (48) = 1904900, p < .001, year affects proportion of full-time males vs females

chi_part <- chisq.test(select(grad_enrollment_contingency, "Part_time_males", "Part_time_females"))
chi_part #chi2 (48) = 692160, p < .001, year affects proportion of part-time males vs females

chi_public_private <- chisq.test(select(grad_enrollment_contingency, "Public", "Private_total"))
chi_public_private #chi2 (48) = 1384600, p < .001, year affects proportion of public vs private


```

Total graduate enrollment of both males and females increased from 1967 to 2015 (Fig. 1).  Male enrollment increased from xx in 1967 to xx in 2015.  Female enrollment increased from xx in 1967 to xx in 2015.  Most notably, up until 1988, total male enrollment exceeded total female enrollment; since 1988, total female enrollment has exceeded total male enrollment.  Thus, there is a significant effect of year on the proportion of male and female graduate students (chi-squared (48) = 2176500, p < 0.001).

Graduate enrollment in both public and private schools increased from 1967 to 2015 (Fig. 2).  Public school enrollment increased form xx in 1967 to xx in 2015.  Private school enrollment increased from xx in 1967 to xx in 2015.  Most notably, up until 2009, total male enrollment exceeded total female enrollment; since 2009, total female enrollment has exceeded total male enrollment.  Thus, there is a significant effect of year on the proportion of graduate students enrolled in public and private schools (chi-squared (48) = 1384600, p < 0.001).

Full-time graduate enrollment of both males and females increased from 1967 to 2015 (Fig. 3).  Full-time male enrollment increased form xx in 1967 to xx in 2015.  Full-time female enrollment increased from xx in 1967 to xx in 2015.  Most notably, up until 1997, total male enrollment exceeded total female enrollment; since 1997, total female enrollment has exceeded total male enrollment.  Thus, there is a significant effect of year on the proportion of male and female full-time graduate students (chi-squared (48) = 1904900, p < 0.001).

Part-time graduate enrollment of both males and females increased from 1967 to 2015 (Fig. 4).  Part-time male enrollment increased form xx in 1967 to xx in 2015.  Part-time female enrollment increased from xx in 1967 to xx in 2015.  Most notably, up until 1975, total male enrollment exceeded total female enrollment; since 1975, total female enrollment has exceeded total male enrollment.  Thus, there is a significant effect of year on the proportion of male and female part-time graduate students (chi-squared (48) = 692160, p < 0.001).
...
The number of female PhD recipients in Education increased from xx in 1985 to xx in 2000, but then decreased to xx in 2015 (Fig. 5).  This is the only field for which the number of recipients declined from 2000 to 2015.  Thus, there is a significant effect of year on the proportion of PhD recipients in Education (chi-squared (2) = 83.404, p < 0.001).

The number of female PhD recipients in Engineering increased from xx in 1985, to xx in 2000, to xx in 2015 (Fig. 5).  Thus, there is a significant effect of year on the proportion of PhD recipients in Engineering (chi-squared (2) = 2989.5, p < 0.001).


The number of female PhD recipients in Humanities & Arts increased from xx in 1985, to xx in 2000, to xx in 2015 (Fig. 5).  Thus, there is a significant effect of year on the proportion of PhD recipients in Humanities & Arts (chi-squared (2) = 542, p < 0.001).


The number of female PhD recipients in Physical & Earth Sciences increased from xx in 1985, to xx in 2000, to xx in 2015 (Fig. 5).  Thus, there is a significant effect of year on the proportion of PhD recipients in Physical & Earth Sciences (chi-squared (2) = 880.67, p < 0.001).
